...
exports.create = function(options) {
  ...
  if (options.lifetimeInSeconds) {
    ...
    confirmationData[0].setAttribute('NotOnOrAfter', now.add('seconds', options.lifetimeInSeconds).format('YYYY-MM-DDTHH:mm:ss.SSS[Z]'));  
  }
  ...
  if (options.audiences) {
    ...
    confirmationData[0].setAttribute('Recipient', audiences[0]);
  }
